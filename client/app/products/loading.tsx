  ...
  return (
    <div className="min-h-screen bg-[#fbfcfe]">
      <div className="mx-auto hidden max-w-[1440px] px-5 pb-16 pt-5 lg:block">
        <div className="rounded-[2rem] border border-[#e7ebf0] bg-white p-4">
          <div className="flex items-center gap-4">
            <div className="h-14 w-52 animate-pulse rounded-2xl bg-[#eef2f6]" />
            <div className="h-14 flex-1 animate-pulse rounded-2xl bg-[#eef2f6]" />
            <div className="h-14 w-40 animate-pulse rounded-2xl bg-[#eef2f6]" />
            <div className="h-14 w-40 animate-pulse rounded-2xl bg-[#eef2f6]" />
          </div>
          <div className="mt-4 h-8 w-full animate-pulse rounded-2xl bg-[#f4f7fb]" />
        </div>
        ...
        <div className="mt-5 grid grid-cols-[300px_minmax(0,1fr)] gap-5">
          <div className="rounded-[2rem] border border-[#e7ebf0] bg-white p-5">
            ...
            <div className="mt-4 space-y-3">
              {Array.from({ length: 6 }, (_, index) => (
                <div key={index} className="h-12 animate-pulse rounded-2xl bg-[#f4f7fb]" />
              ))}
            </div>
          </div>
      ...
      <div className="px-4 pb-28 pt-5 lg:hidden">
        ...
        <div className="mt-4 h-14 w-full animate-pulse rounded-[1.35rem] bg-white" />
        <div className="mt-4 flex gap-3 overflow-hidden">
          {Array.from({ length: 4 }, (_, index) => (
            <div
              key={index}
              className="h-24 min-w-[92px] animate-pulse rounded-[1.35rem] bg-white"
            />
          ))}
        </div>
        ...
        <div className="mt-5 grid grid-cols-2 gap-4">
          {Array.from({ length: 6 }, (_, index) => (
            <div key={index} className="space-y-3">
              <div className="aspect-[0.84] animate-pulse rounded-[1.4rem] bg-white" />
