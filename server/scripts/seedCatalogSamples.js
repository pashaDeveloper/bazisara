  ...
  const articles = [
    {
      ...
      content: "<p>این یک مطلب نمونه است تا فیلتر دسته‌بندی و کارت‌ها در مجله واقعی دیده شوند.</p>",
    ...
    },
    {
      ...
      content: "<p>این مطلب برای نمایش فیلتر دسته‌بندی و کارت مقاله اضافه شده است.</p>",
      author: "تحریریه بازی سرا",
      readingTime: "۵ دقیقه",
    ...
    },
    {
      ...
      content: "<p>نمونه مقاله‌ای برای تست فیلتر و دسته‌بندی در صفحه مجله.</p>",
      author: "تحریریه بازی سرا",
      readingTime: "۴ دقیقه",
