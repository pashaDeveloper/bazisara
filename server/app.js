...
app.use("/api/warranty-companies", require("./routes/warrantyCompany.route"));
app.use("/api/warranties", require("./routes/warranty.route"));
app.use("/api/insurance-companies", require("./routes/insuranceCompany.route"));
app.use("/api/insurances", require("./routes/insurance.route"));
