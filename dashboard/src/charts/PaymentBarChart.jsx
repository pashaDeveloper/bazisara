...
function PaymentBarChart({
  ...
  width,
  height,
  valueType = 'currency' // 'currency' or 'count'
}) {
      ...
      plugins: [
        {
          ...
          afterUpdate(c, args, options) {
            ...
            items.forEach((item) => {
              ...
              value.style.fontSize = tailwindConfig().theme.fontSize.base[0];
              value.style.lineHeight = tailwindConfig().theme.fontSize.base[1].lineHeight;
  ...
  return (
    <React.Fragment>
      <div className="px-5 py-3">
        <ul ref={legend} className="flex flex-wrap gap-x-4 text-sm"></ul>
      </div>
      <div className="grow">
